...
def parse_input_files(args: argparse.Namespace) -> tuple[dict, str, list]:
    try:
        ...
        validated_prompts = [Prompt(**obj).model_dump()
                             for obj in raw_prompts]
        return list_of_functions, functions_tools, validated_prompts
